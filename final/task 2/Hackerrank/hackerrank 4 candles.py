...
for i in range (n):
        print ("enter height of candle", i+1)   
        inp = int(input("---    "))
        mat.append(inp)            # stores the heights in an array

print (mat)



def find_highest_candle():       ## find highest candle 
...
def find_count():              # find number of highest candles 
        global high_val
